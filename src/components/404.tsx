  ...
  return (
    <>
      ...
      <main className="flex min-h-svh items-center overflow-hidden text-foreground">
        <div className="mx-auto flex min-h-full w-full max-w-9xl flex-col gap-12 px-6 py-16 lg:grid lg:grid-cols-[1.2fr_0.8fr] lg:items-center">
